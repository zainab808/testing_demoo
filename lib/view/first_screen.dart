            ...
            Row(
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Text("Search google or Type a URL"),
                        const Spacer(),
                ...
                Container(
                    ...
                    width: 35,
                    decoration: BoxDecoration(
                        color: const Color.fromARGB(255, 204, 221, 243),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Text("Serach a google or type a URL"),
                          const Spacer(), // last par karnye k liye
                          Image.network(
                      ...
                      Column(
                        children: [
                          Container(
                            ...
                            width: 50,
                            decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 205, 221, 242),
                                borderRadius: BorderRadius.circular(25)),
                            child: const Center(
                                child: Text(
                              "+",
